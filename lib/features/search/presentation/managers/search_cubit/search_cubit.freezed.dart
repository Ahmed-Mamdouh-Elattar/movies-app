...
class Loaded implements SearchState {
  const Loaded(final  List<SearchMoviesEntity> movies): _movies = movies;
...
class Failure implements SearchState {
...
@override
String toString() {
  return 'SearchState.failure(errMessage: $errMessage)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<$Res> implements $SearchStateCopyWith<$Res> {
